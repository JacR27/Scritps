...
/Selecting matches/{ if (NF==14) { startsel[$12,$11]=time-start } else {endsel[$16,$15]=time-start}}
/Loading Bcl/{if (NF==12) startread[$10,$9]=time-start; else { endread[$11,$10]=time-start}}
