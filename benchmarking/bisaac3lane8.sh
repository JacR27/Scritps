...
nohup /usr/bin/time -v $command -r /illumina/development/Isis/Genomes/Homo_sapiens/UCSC/hg19/Sequence/IsaacIndex5/sorted-reference.xml -b RunInfo.xml --base-calls-format bcl-gz -m 59 --tiles s_8 -o ${workingdir}${analysisdir}/Align > ${workingdir}${analysisdir}${processName}.stdout
